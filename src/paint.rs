...
impl GifArtist {
    pub fn new(gif: Vec<Frame>, tolerance: f32, color_limit: ColorLimit) -> Self {
...
impl Artist {
    pub fn new(img: ImageBuffer<Rgba<u8>, Vec<u8>>) -> Self {
    ...
    pub fn paint(&mut self, tolerance: f32, color_limit: ColorLimit) {
